...
class TestParseValidVtt:
    def test_parse_valid_vtt_multi_speaker(self, sample_vtt: str) -> None:
        result = parse_vtt(sample_vtt, **_kwargs())  # type: ignore[arg-type]
...
class TestEdgeCases:
    def test_parse_empty_vtt(self) -> None:
        result = parse_vtt("", **_kwargs())  # type: ignore[arg-type]
    ...
    def test_parse_malformed_vtt_no_crash(self) -> None:
        ...
        result = parse_vtt(malformed, **_kwargs())  # type: ignore[arg-type]
    ...
    def test_parse_truncated_cue_no_crash(self) -> None:
        truncated = "WEBVTT\n\n00:00:01.000 --> 00:00:02.000\n"
        result = parse_vtt(truncated, **_kwargs())  # type: ignore[arg-type]
    ...
    def test_parse_vtt_without_speaker_labels(self) -> None:
        ...
        result = parse_vtt(no_labels, **_kwargs())  # type: ignore[arg-type]
    ...
    def test_parse_vtt_preserves_participants(self) -> None:
        result = parse_vtt("WEBVTT\n\n", **_kwargs(participants=["Alice", "Bob"]))  # type: ignore[arg-type]
    ...
    def test_parse_vtt_webvtt_header_ignored(self) -> None:
        ...
        result = parse_vtt(vtt_with_header, **_kwargs())  # type: ignore[arg-type]
